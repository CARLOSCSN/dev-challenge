...
install_desktop(){
echo ${G}"Installing LXDE Desktop..."${W}
...
apt-get install lxde gnome-terminal dbus-x11 tigervnc-standalone-server -y
echo "vncserver -geometry 1280x720 -xstartup /usr/bin/startlxde" >> /usr/local/bin/vncstart

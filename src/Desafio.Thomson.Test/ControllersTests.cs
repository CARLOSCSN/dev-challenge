using Desafio.Bitium.Controllers;
...
namespace Desafio.Bitium.Test
{
    ...
    public class ControllersTest
    {
        ...
        public void Domain_In_Database()
        {
            ...
            var domain = new Domain { Id = 1, Ip = "192.168.0.1", Name = "test.com", UpdatedAt = DateTime.Now, HostedAt = "Bitium.corp", Ttl = 60, WhoIs = "Ns.Bitium.com" };
